...
public class Calibration {
	...
	public static final double GEAR_PICKUP_ARM_READY = 0;
	public static final double GEAR_PICKUP_ARM_PARK = 0.17; // competition
	public static final double GEAR_PICKUP_ARM_VERTICAL = 0.21; // competition bot
	public static final double GEAR_PICKUP_ARM_HORIZONTAL = 0.48; //competition
